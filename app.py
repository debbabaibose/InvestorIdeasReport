...
try:
    ...
    if report_options == 'Cost vs Portfolio value':
        ...
        # Read the data
        df = pd.read_csv('Annualised ROI/September01/compound_return_s2f.csv')
    ...
    if report_options == 'Annualised ROI':
        ...
        if mode == 'Support 2 to':
            df = pd.read_csv('Annualised ROI/September01/compound_return_s2t.csv')
         
        if mode == 'Support 1 from':
            df = pd.read_csv('Annualised ROI/September01/compound_return_s1f.csv')    
         
        if mode == 'Support 1 to':
            df = pd.read_csv('Annualised ROI/September01/compound_return_s1t.csv')
    ...
    if report_options == 'Compound Return':
        ...
        if mode !='Compare':
            ...
            if mode == 'Nifty50':
                # Read the data
                df = pd.read_csv('Annualised ROI/September01/Compound_Return_Nifty50.csv')
            
            if mode == 'NiftyMidCap50':
                # Read the data
                df = pd.read_csv('Annualised ROI/September01/Compound_Return_NiftyMidcap50.csv')
                  
            if mode == 'NiftySmallCap50':
                # Read the data
                df = pd.read_csv('Annualised ROI/September01/Compound_Return_NiftySmallcap50.csv')
        ...
        if mode == 'Compare':
        # Read the data
            df_s2f = pd.read_csv('Annualised ROI/September01/compound_return_s2f.csv')
            df_nifty50 = pd.read_csv('Annualised ROI/September01/Compound_Return_Nifty50.csv')
            df_nifty_midcap50 = pd.read_csv('Annualised ROI/September01/Compound_Return_NiftyMidcap50.csv')
            df_nifty_smallcap50 = pd.read_csv('Annualised ROI/September01/Compound_Return_NiftySmallcap50.csv')
    ...
    if report_options == 'User Buys on Every Report Date':
        ...
        if mode == 'Annualised ROI':
            ...
            df = pd.read_csv('Annualised ROI/September01/compound_return_userbuysoneveryreportdate.csv')
    ...
    if report_options == 'Daywise Absolute Return':
        ...
        if mode == 'Line Chart':
            ...
            df = pd.read_csv('Annualised ROI/September01/daywise_return.csv')
